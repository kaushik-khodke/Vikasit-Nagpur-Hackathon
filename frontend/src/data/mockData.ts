...
export const mockSightings: Sighting[] = [
  {
    ...
    candidateBaselineUrl: 'https://images.unsplash.com/photo-1534188753412-3e26d0d618d6?auto=format&fit=crop&w=400&q=80',
  ...
  },
  {
    ...
    candidateBaselineUrl: 'https://images.unsplash.com/photo-1575550959106-5a7defe28b56?auto=format&fit=crop&w=400&q=80',
    environmentalConditions: {
      timeOfDay: 'NIGHT',
      weather: 'Dry',
  ...
  },
  {
    ...
    candidateBaselineUrl: 'https://images.unsplash.com/photo-1561731216-c3a4d99437d5?auto=format&fit=crop&w=400&q=80',
    environmentalConditions: {
      timeOfDay: 'NIGHT',
      weather: 'Overcast',
  ...
  },
  {
    ...
    candidateBaselineUrl: 'https://images.unsplash.com/photo-1549480017-d76466a4b7e8?auto=format&fit=crop&w=400&q=80',
    environmentalConditions: {
      timeOfDay: 'NIGHT',
      weather: 'Dry',
...
export const mockCameraTraps: CameraTrap[] = [
  ...
  // --------------------------------------------------------------------------
  // 5 Edge Perimeter Cameras (Inside Pench Border, Proximate to Villages)
  // --------------------------------------------------------------------------
  {
    id: 'CAM-EDGE-01',
    code: 'CAM-EDGE-01',
    ...
    totalCapturesRecorded: 142,
    tigersObservedCount: 4,
    isEdgeCamera: true,
  ...
  },
  {
    ...
    totalCapturesRecorded: 115,
    tigersObservedCount: 5,
    isEdgeCamera: true,
